...
export const PARTNERS_DATA: PartnerCategory[] = [
  {
    ...
    items: [
      ...
      { name: "대구가정법원", image: "https://res.cloudinary.com/dxjz9ksjg/image/upload/v1775044656/logo_gibhqm.png", link: "https://dgfamily.scourt.go.kr/" },
      { name: "대구광역시", image: "https://res.cloudinary.com/dxjz9ksjg/image/upload/v1775106397/%EC%8B%AC%EB%B2%8C%EB%A1%9C%EA%B3%A0%EC%A1%B0%ED%95%A9_dgtm0l.png", link: "https://www.daegu.go.kr/" },
      { name: "대구광역시교육청", image: "https://res.cloudinary.com/dxjz9ksjg/image/upload/v1775034616/Daegu_Metropolitan_Office_of_Education_Logo__vertical.svg_de9yzu.png", link: "http://www.dge.go.kr/" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "영남 지역 디지털대학교", image: "https://res.cloudinary.com/dxjz9ksjg/image/upload/v1775046633/%EC%A0%9C%EB%AA%A9_%EC%97%86%EC%9D%8C_lgknb0.png", link: "https://www.bdu.ac.kr/" },
      ...
      { name: "영남 지역 외국어대학교", image: "https://res.cloudinary.com/dxjz9ksjg/image/upload/v1775282540/0S5zqzZ3OZ0sDrUNrwOY4VPNA0JXBATRC_lutxzgtHjFdn0EO1POXAi-yEwwEcbrM0xNxequghYxGTE-mYclqlBjbw_XVLmpWHom5V9tUnOlNeqT-jr-BgXzkF95zpKE5u_-htBqRvEAgSK6TcblOw_leu6dr.webp", link: "https://www.bufs.ac.kr/" },
