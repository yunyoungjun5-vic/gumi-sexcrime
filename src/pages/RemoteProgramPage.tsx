        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/15 backdrop-blur-md border border-white/25 text-white mb-8">
              ...
              <span className="text-sm font-bold tracking-wide">구미 비대면 원격 프로그램</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 w-full px-4 sm:px-0">
              <a href="https://map.naver.com/p/entry/place/20046727?c=15.00,0,0,0,dh&placePath=/ticket?from=map&fromPanelNum=1&additionalHeight=76&timestamp=202605150022&locale=ko&svcName=map_pcv5" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-10 py-5 bg-remote-mint hover:bg-remote-mint-hover text-white rounded-full font-bold text-lg transition-all duration-300 hover:scale-105 shadow-[0_10px_30px_rgba(31,199,182,0.3)] flex items-center justify-center gap-2 break-keep">
                실시간 상담 예약하기
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 w-full">
            ...
            <a href="tel:0507-1378-5463" className="w-full sm:w-auto px-10 py-5 bg-white/15 hover:bg-white/25 backdrop-blur-md border border-white/25 text-white rounded-full font-bold text-lg transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 break-keep">
