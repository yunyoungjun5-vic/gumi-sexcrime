...
const MEDIA_DATA = [
  ...
  },
  {
    ...
    summary: "영남 지역 다문화 가족 지원센터 출강 강의",
    featured: false
  },
  {
    id: 124,
      ...
      <section className="py-24 bg-slate-900 text-white text-center">
        <div className="container-custom">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="tel:0507-1378-5463" className="btn-primary flex items-center justify-center gap-2">
              <PhoneCall className="w-5 h-5" />
              문의하기 0507-1378-5463
            </a>
            <a href="https://map.naver.com/p/entry/place/20046727?c=15.00,0,0,0,dh&placePath=/ticket?from=map&fromPanelNum=1&additionalHeight=76&timestamp=202605150022&locale=ko&svcName=map_pcv5" target="_blank" rel="noopener noreferrer" className="btn-primary bg-white text-slate-900 hover:bg-slate-100 flex items-center justify-center gap-2">
